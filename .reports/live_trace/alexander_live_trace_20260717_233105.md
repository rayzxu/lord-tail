...
- created_at: `2026-07-17T23:31:05`
...
| `train_infantry` | `True` | `POST /api/game/turn, POST /api/game/turn, POST /api/game/turn` | `POST /api/game/turn, POST /api/game/turn, POST /api/game/turn` | `{"passed": true, "army": {"infantry": 2, "archers": 0, "cavalry": 0}}` |
| `train_archers` | `True` | `POST /api/game/turn, POST /api/game/turn, POST /api/game/turn, POST /api/game/turn` | `POST /api/game/turn, POST /api/game/turn, POST /api/game/turn, POST /api/game/turn` | `{"passed": true, "army": {"infantry": 2, "archers": 2, "cavalry": 0}}` |
| `train_cavalry` | `True` | `POST /api/game/turn, POST /api/game/turn, POST /api/game/turn, POST /api/game/turn, POST /api/game/turn` | `POST /api/game/turn, POST /api/game/turn, POST /api/game/turn, POST /api/game/turn, POST /api/game/turn` | `{"passed": true, "army": {"infantry": 2, "archers": 2, "cavalry": 2}}` |
...
| `real_hermes_describe_lord` | `True` | `POST /api/agent/runs, GET /api/agent/runs/{run_id}/events, GET /api/agent/runs/{run_id}` | `POST /api/agent/runs, GET /api/agent/runs/{run_id}/events, GET /api/agent/runs/{run_id}` | `{"expected_hermes_events": ["run.started", "message.delta", "run.completed"], "passed": true, "status": "completed", "event_names": ["run.started", "message.delta", "message.delta", "message.delta", "message.delta", "message.delta", "message.delta", "message.delta", "message.delta", "message.delta", "message.delta", "message.delta", "message.delta", "mess...` |
| `real_hermes_story_turn_with_expected_actions` | `False` | `POST /api/agent/runs, GET /api/agent/runs/{run_id}/events, GET /api/agent/runs/{run_id}` | `POST /api/agent/runs, GET /api/agent/runs/{run_id}/events, GET /api/agent/runs/{run_id}` | `{"expected_hermes_events": ["run.started", "run.completed"], "passed": false, "status": "completed", "event_names": ["run.started", "message.delta", "message.delta", "message.delta", "message.delta", "message.delta", "message.delta", "message.delta", "message.delta", "message.delta", "message.delta", "message.delta", "message.delta", "message.delta", "mes...` |
